...
function App(){
 ...
 const nav=isReception?['BOARD','Nghỉ phép']:isPT?['BOARD','Show PT','Kế Hoạch','Nghỉ phép']:['Tổng quan','Lead','Pipeline','Lịch hẹn','BOARD',...(isAdmin||isManager?['Đề xuất']:[]),'Nghỉ phép','Show PT','Kế Hoạch',...(isAdmin||isManager?['Báo cáo','Báo cáo công việc']:[]),...(isAdmin?['Cơ sở',`Tài khoản${pending?' ('+pending+')':''}`]:[]),'Zalo/Facebook'];
